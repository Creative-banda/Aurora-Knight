...
SCREEN_THRUST_X = 400
MAP_WIDTH = 100 * CELL_SIZE  # Width of the map (100 cells in a row * CELL_SIZE)
...
# Hurt sounds
hurt_sound = [pygame.mixer.Sound(f"{SOUND_DIR}/grunt_{i}.mp3") for i in range(1, 7)]
